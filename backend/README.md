...
This is the main service. It is built using [Flask](https://flask.palletsprojects.com/en/1.1.x/) and [SQLite](https://www.sqlite.org/index.html). This service is intended to main service. When developing, you can access the service at this url: [http://127.0.0.1:5000](http://127.0.0.1:5000)
